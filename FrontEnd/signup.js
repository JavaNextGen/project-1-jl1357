...
async function signupfunction() {
    ...
    console.log(user)
    let usernamechecker = await fetch(url+"usernamechecker/"+usern);
    let emailchecker = await fetch(url+"emailchecker/"+email);
    console.log(usernamechecker.status);
    console.log(emailchecker.status);
        ...
        if(response.status === 200 && usernamechecker.status === 201 && emailchecker.status === 201) {
